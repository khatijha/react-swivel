...
class AddressInfoForm extends Component{
  ...
  getStoreInfo = e => {
    this.props.getPreferLocationInfo().then(resp => {
      this.setState({
        store: resp.data,
  ...
  onSubmit = event => {
    ...
    form.validateFields((error, values) => {
      ...
      if (!error) {
        ...
        AddressInfoForm.self.props.updatePreferLocation(values).then(resp => {
          AddressInfoForm.self.props.setLoading(false);
...
const mapDispatchToProps = (dispatch) => ({
  getPreferLocationInfo: () => api.getPreferLocationInfo(),
