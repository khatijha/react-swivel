...
class AccountingForm extends Component{
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      states: [],
      birthday: null,
      avatar:  (props.userInfo && props.userInfo.avatar) ? props.userInfo.avatar : '/resources/images/avatar.jpg',
    };
  }
  componentDidMount() {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    if(this.state.userInfo !== this.props.userInfo) {
      this.setState({
        ...
        avatar:  (this.props.userInfo && this.props.userInfo.avatar) ? this.props.userInfo.avatar : '/resources/images/avatar.jpg',
      });
