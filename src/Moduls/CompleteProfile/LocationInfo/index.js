  ...
  onSubmit = event => {
    ...
    form.validateFields((error, values) => {
      ...
      if (!error) {
        ...
        StoreInfo.self.props.updatePreferLocation(values).then(resp => {
          StoreInfo.self.props.setLoading(false);
          StoreInfo.self.props.updateStep(3);
      ...
      <div className='store-info'>
        <div>
          <Form layout="vertical" className='form-group row'  hideRequiredMark onSubmit={this.onSubmit}>
            <label className='store-info--head col-12'>Details of Location to coordinate better with vendor products</label>
...
const StoreInfo = Form.create()(GoogleApiWrapper({
...
const mapDispatchToProps = (dispatch) => ({
  updatePreferLocation: (obj) => api.updatePreferLocation(obj),
