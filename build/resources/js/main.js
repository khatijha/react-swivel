...
(function ($) {
  ...
  var Porto = {
    ...
    filterSlider: function () {
      // 1-Slider For category pages / filter price
    ...
    lightBox: function () {
      ...
      //QuickView Popup
      $('body').on('click', 'a.btn-quickview-cancelthisevent', function (e) {
        e.preventDefault();
        Porto.ajaxLoading();
